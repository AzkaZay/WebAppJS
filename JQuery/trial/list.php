...
#container {
   width: 40%; /* Reduced from 50% to 40% */
	height:400px;
   max-width: 500px; /* Ensures it doesn’t get too large on bigger screens */
   margin: 50px auto; /* Reduced margin for better spacing */
   box-shadow: 0 0 2px rgba(0, 0, 0, 0.1); /* Slightly softer shadow */
   background: #f7f7f7;
   filter: drop-shadow(0px 0px 0.6rem #000000); /* Reduced shadow intensity */
   padding: 10px; /* Added some inner spacing */
   border-radius: 5px; /* Optional: Softened corners */
}
...
.btn.btn-success.btn-lg {
    ...
    margin-bottom: 800px;
    position: relative;
    top: -1050px;  /* Moves the button up */
    left: 500px;   /* Moves the button to the right */
    filter: drop-shadow(0px 0px 0.9rem #fff);
}
.btn.btn-primary.btn-lg {
    margin: 500px;
    position: relative;
    top: -500px;  /* Moves the button down */
    filter: drop-shadow(0px 0px 0.9rem #fff);
}
    </style>
	<meta charset="utf-8" />
...
<a href="Carousel.php" class="btn btn-primary btn-lg">Gallery</a>
